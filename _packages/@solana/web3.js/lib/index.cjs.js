...
var _classCallCheck__default =
  /*#__PURE__*/ _interopDefaultLegacy(_classCallCheck);
...
var _toConsumableArray__default =
  /*#__PURE__*/ _interopDefaultLegacy(_toConsumableArray);
var _slicedToArray__default =
  /*#__PURE__*/ _interopDefaultLegacy(_slicedToArray);
...
var createKeccakHash__default =
  /*#__PURE__*/ _interopDefaultLegacy(createKeccakHash);
    ...
    [
      {
        key: 'createWithSeed',
        value: (function () {
          var _createWithSeed = _asyncToGenerator__default['default'](
            /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
              function _callee(fromPublicKey, seed, programId) {
                var buffer, hash;
                      ...
                      switch ((_context.prev = _context.next)) {
                        ...
                        case 3:
                          ...
                          return _context.abrupt(
                            'return',
                            new PublicKey(Buffer.from(hash, 'hex')),
                          );
      ...
      },
      {
        ...
        value: (function () {
          var _createProgramAddress = _asyncToGenerator__default['default'](
            /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
              function _callee2(seeds, programId) {
                  ...
                  function _callee2$(_context2) {
                    while (1) {
                      switch ((_context2.prev = _context2.next)) {
                        ...
                        case 5:
                          hash = _context2.sent;
                          publicKeyBytes = new BN__default['default'](
                            hash,
                            16,
                          ).toArray(null, 32);
      ...
      },
      {
        ...
        value: (function () {
          var _findProgramAddress = _asyncToGenerator__default['default'](
            /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
              function _callee3(seeds, programId) {
                    ...
                    while (1) {
                      switch ((_context3.prev = _context3.next)) {
                        ...
                        case 1:
                          ...
                          _context3.next = 6;
                          return this.createProgramAddress(
                            seedsWithNonce,
                            programId,
                          );
...
var Account = /*#__PURE__*/ (function () {
  ...
  function Account(secretKey) {
    ...
    if (secretKey) {
      this._keypair = nacl__default.default.sign.keyPair.fromSecretKey(
        toBuffer(secretKey),
      );
    } else {
...
var BPF_LOADER_DEPRECATED_PROGRAM_ID = new PublicKey(
      ...
      },
      {
        ...
        value: function serialize() {
          ...
          instructions.forEach(function (instruction) {
            var instructionLayout = BufferLayout.struct([
    ...
    [
      {
        ...
        value: function from(buffer) {
          ...
          for (var i = 0; i < accountCount; i++) {
            ...
            accountKeys.push(
              bs58__default['default'].encode(Buffer.from(account)),
            );
          }
          ...
          for (var _i = 0; _i < instructionCount; _i++) {
            ...
            instruction.data = bs58__default['default'].encode(
              Buffer.from(data),
            );
          ...
          var messageArgs = {
            ...
            recentBlockhash: bs58__default['default'].encode(
    ...
    [
      ...
      },
      {
        ...
        value: function compileMessage() {
          ...
          accountMetas.sort(function (x, y) {
            var checkSigner =
              x.isSigner === y.isSigner ? 0 : x.isSigner ? -1 : 1;
            var checkWritable =
          ...
          if (feePayerIndex > -1) {
            var _uniqueMetas$splice = uniqueMetas.splice(feePayerIndex, 1),
              _uniqueMetas$splice2 = _slicedToArray__default['default'](
                _uniqueMetas$splice,
                1,
              ),
          ...
          try {
            var _loop = function _loop() {
              ...
              if (uniqueIndex > -1) {
                ...
                throw new Error(
                  'unknown signer: '.concat(signature.publicKey.toString()),
                );
              }
            };
      ...
      },
      {
        ...
        value: function _compile() {
          ...
          var signedKeys = message.accountKeys.slice(
            0,
      ...
      },
      {
        ...
        value: function setSigners() {
          for (
            var _len2 = arguments.length, signers = new Array(_len2), _key2 = 0;
            _key2 < _len2;
            _key2++
          ) {
      ...
      },
      {
        ...
        value: function sign() {
          for (
            var _len3 = arguments.length, signers = new Array(_len3), _key3 = 0;
            _key3 < _len3;
            _key3++
          ) {
      ...
      },
      {
        ...
        value: function partialSign() {
          for (
            var _len4 = arguments.length, signers = new Array(_len4), _key4 = 0;
            _key4 < _len4;
            _key4++
          ) {
          ...
          for (
            var _i2 = 0, _signers2 = signers;
            _i2 < _signers2.length;
            _i2++
          ) {
        ...
        value: function _partialSign(message) {
          ...
          for (
            var _len5 = arguments.length,
              signers = new Array(_len5 > 1 ? _len5 - 1 : 0),
              _key5 = 1;
            _key5 < _len5;
            _key5++
          ) {
          ...
          signers.forEach(function (signer) {
            var signature = nacl__default['default'].sign.detached(
              signData,
              signer.secretKey,
            );
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
              ...
              if (signature === null) {
                ...
                if (
                  !nacl__default['default'].sign.detached.verify(
                    signData,
                    signature,
                    publicKey.toBuffer(),
                  )
    ...
    [
      {
        ...
        value: function from(buffer) {
          ...
          for (var i = 0; i < signatureCount; i++) {
            ...
            signatures.push(
              bs58__default['default'].encode(Buffer.from(signature)),
            );
          }
      ...
      },
      {
        ...
        value: function populate(message, signatures) {
          ...
          signatures.forEach(function (signature, index) {
            var sigPubkeyPair = {
              signature:
                signature == bs58__default['default'].encode(DEFAULT_SIGNATURE)
                  ? null
                  : bs58__default.default.decode(signature),
...
var SYSVAR_CLOCK_PUBKEY = new PublicKey(
  'SysvarC1ock11111111111111111111111111111111',
);
var SYSVAR_RECENT_BLOCKHASHES_PUBKEY = new PublicKey(
  'SysvarRecentB1ockHashes11111111111111111111',
);
var SYSVAR_RENT_PUBKEY = new PublicKey(
  'SysvarRent111111111111111111111111111111111',
);
var SYSVAR_REWARDS_PUBKEY = new PublicKey(
  'SysvarRewards111111111111111111111111111111',
);
var SYSVAR_STAKE_HISTORY_PUBKEY = new PublicKey(
  'SysvarStakeHistory1111111111111111111111111',
);
var SYSVAR_INSTRUCTIONS_PUBKEY = new PublicKey(
...
var NonceAccountLayout = BufferLayout.struct([
...
function jsonRpcResult(resultDescription) {
  ...
  return superstruct.struct.union([
    superstruct.struct({
...
var GetLeaderScheduleResult = superstruct.struct.record([
  'string',
...
var SimulatedTransactionResponseValidator = jsonRpcResultAndContext(
  superstruct.struct.pick({
    err: superstruct.struct.union(['null', 'object', 'string']),
    logs: superstruct.struct.union([
      'null',
      superstruct.struct.array(['string']),
    ]),,
  }),
);
...
function createRpcRequest(url, useHttps) {
  ...
  var server = jayson__default.default(
    /*#__PURE__*/ (function () {
      var _ref = _asyncToGenerator__default['default'](
        /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
          function _callee(request, callback) {
                    ...
                    case 14:
                      console.log(
                        'Server responded with '
                          .concat(res.status, ' ')
                          .concat(res.statusText, '.  Retrying after ')
                          .concat(waitTime, 'ms delay...'),
                      );
                      _context.next = 17;
 ...
 */
var GetTokenLargestAccountsResult = jsonRpcResultAndContext(
  superstruct.struct.array([
    superstruct.struct.pick({
      address: 'string',
      amount: 'string',
      uiAmount: 'number',
...
var GetParsedTokenAccountsByOwner = jsonRpcResultAndContext(
  superstruct.struct.array([
    superstruct.struct.object({
      pubkey: 'string',
      account: superstruct.struct.object({
...
var ParsedAccountInfoResult = superstruct.struct.object({
  ...
  owner: 'string',
  lamports: 'number',
  data: superstruct.struct.union([
    ['string', superstruct.struct.literal('base64')],
    superstruct.struct.pick({
      program: 'string',
      parsed: 'any',
      space: 'number',,
...
var StakeActivationResult = superstruct.struct.object({
  state: superstruct.struct.union([
    superstruct.struct.literal('active'),
    superstruct.struct.literal('inactive'),
    superstruct.struct.literal('activating'),
    superstruct.struct.literal('deactivating'),
  ]),
  active: 'number',
  inactive: 'number',
});
...
var GetAccountInfoAndContextRpcResult = jsonRpcResultAndContext(
  superstruct.struct.union(['null', AccountInfoResult]),
);
/**
 * Expected JSON RPC response for the "getAccountInfo" message with jsonParsed param
 */

var GetParsedAccountInfoResult = jsonRpcResultAndContext(
  superstruct.struct.union(['null', ParsedAccountInfoResult]),
);
/**
...
var GetConfirmedSignaturesForAddressRpcResult = jsonRpcResult(
  superstruct.struct.array(['string']),
);
/**
...
var GetConfirmedSignaturesForAddress2RpcResult = jsonRpcResult(
  superstruct.struct.array([
    superstruct.struct({
      signature: 'string',
      slot: 'number',
...
var GetProgramAccountsRpcResult = jsonRpcResult(
  superstruct.struct.array([ProgramAccountInfoResult]),
);
/**
 * Expected JSON RPC response for the "getProgramAccounts" message
 */

var GetParsedProgramAccountsRpcResult = jsonRpcResult(
  superstruct.struct.array([ParsedProgramAccountInfoResult]),
);
/**
...
var GetVoteAccounts = jsonRpcResult(
  superstruct.struct({
    current: superstruct.struct.array([
      superstruct.struct.pick({
        votePubkey: 'string',
        nodePubkey: 'string',
        activatedStake: 'number',
        epochVoteAccount: 'boolean',
        epochCredits: superstruct.struct.array([
          superstruct.struct.tuple(['number', 'number', 'number']),
        ]),
        commission: 'number',
        lastVote: 'number',
        rootSlot: 'number?',,
    ...
    delinquent: superstruct.struct.array([
      superstruct.struct.pick({
        votePubkey: 'string',
        nodePubkey: 'string',
        activatedStake: 'number',
...
var ConfirmedTransactionResult = superstruct.struct({
  ...
  message: superstruct.struct({
    ...
    instructions: superstruct.struct.array([
      superstruct.struct({
...
var ParsedConfirmedTransactionResult = superstruct.struct({
  signatures: superstruct.struct.array(['string']),
  message: superstruct.struct({
    accountKeys: superstruct.struct.array([
      superstruct.struct({
        pubkey: 'string',
        signer: 'boolean',
        writable: 'boolean',,
...
var ConfirmedTransactionMetaResult = superstruct.struct.union([
  'null',
  superstruct.struct.pick({
    err: TransactionErrorResult,
    fee: 'number',
    innerInstructions: superstruct.struct.union([
      superstruct.struct.array([
        superstruct.struct({
          index: 'number',
          instructions: superstruct.struct.array([
    ...
    logMessages: superstruct.struct.union([
      superstruct.struct.array(['string']),
      'null',
      'undefined',
    ]),,
...
var ParsedConfirmedTransactionMetaResult = superstruct.struct.union([
  'null',
  superstruct.struct.pick({
    err: TransactionErrorResult,
    fee: 'number',
...
var GetConfirmedBlockRpcResult = jsonRpcResult(
  superstruct.struct.union([
    ...
    superstruct.struct.pick({
      ...
      parentSlot: 'number',
      transactions: superstruct.struct.array([
        superstruct.struct({
          transaction: ConfirmedTransactionResult,
          meta: ConfirmedTransactionMetaResult,,
        }),
      ]),
      rewards: superstruct.struct.union([
        'undefined',
        superstruct.struct.array([
          superstruct.struct({
            pubkey: 'string',
...
var GetParsedConfirmedTransactionRpcResult = jsonRpcResult(
  superstruct.struct.union([
    'null',
    superstruct.struct.pick({
      slot: 'number',
...
var GetRecentPerformanceSamplesRpcResult = jsonRpcResult(
  superstruct.struct.array([
    superstruct.struct.pick({
      slot: 'number',
...
var Connection = /*#__PURE__*/ (function () {
  ...
  function Connection(endpoint, commitment) {
    ...
    _defineProperty__default.default(
      this,
      '_accountChangeSubscriptionCounter',
      0,
    );
  ...
  _createClass__default['default'](Connection, [
    {
       ...
       */
      value: (function () {
        var _getBalanceAndContext = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee2(publicKey, commitment) {
    ...
    },
    {
      key: 'getBalance',
      value: (function () {
        var _getBalance = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee3(publicKey, commitment) {
              return _regeneratorRuntime__default['default'].wrap(
                function _callee3$(_context3) {
                  while (1) {
                    switch ((_context3.prev = _context3.next)) {
    ...
    },
    {
      key: 'getBlockTime',
      value: (function () {
        var _getBlockTime = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee4(slot) {
              var unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context4.prev = _context4.next)) {
                      ...
                      case 2:
                        ...
                        throw new Error(
                          'failed to get block time for slot ' +
                            slot +
                            ': ' +
                            res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getMinimumLedgerSlot = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee5() {
              var unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      ...
      value: (function () {
        var _getFirstAvailableBlock = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee6() {
              var unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      key: 'getSupply',
      value: (function () {
        var _getSupply = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee7(commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context7.prev = _context7.next)) {
                      ...
                      case 3:
                        ...
                        throw new Error(
                          'failed to get supply: ' + res.error.message,
                        );
                      ...
                      case 7:
                        ...
                        res.result.value.nonCirculatingAccounts =
                          res.result.value.nonCirculatingAccounts.map(function (
                            account,
                          ) {
                            return new PublicKey(account);
                          });
    ...
    },
    {
      key: 'getTokenSupply',
      value: (function () {
        var _getTokenSupply = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee8(tokenMintAddress, commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context8.prev = _context8.next)) {
                      ...
                      case 3:
                        ...
                        throw new Error(
                          'failed to get token supply: ' + res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getTokenAccountBalance = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee9(tokenAddress, commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      ...
      value: (function () {
        var _getTokenAccountsByOwner = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee10(ownerAddress, filter, commitment) {
    ...
    },
    {
      ...
      value: (function () {
        var _getParsedTokenAccountsByOwner = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee11(ownerAddress, filter, commitment) {
              var _args, args, unsafeRes, res, result, context, value;
    ...
    },
    {
      ...
      value: (function () {
        var _getLargestAccounts = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee12(config) {
                ...
                function _callee12$(_context12) {
                  while (1) {
                    switch ((_context12.prev = _context12.next)) {
                      case 0:
                        arg = _objectSpread$1(
                          _objectSpread$1({}, config),
                          {},
                          {
                            commitment:
                              (config && config.commitment) || this.commitment,,
                          },
                        );
                      ...
                      case 8:
                        ...
                        res.result.value = res.result.value.map(function (
                          _ref2,
                        ) {
    ...
    },
    {
      ...
      value: (function () {
        var _getTokenLargestAccounts = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee13(mintAddress, commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      ...
      value: (function () {
        var _getAccountInfoAndContext = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee14(publicKey, commitment) {
              var args,
                unsafeRes,
                res,
                value,
    ...
    },
    {
      ...
      value: (function () {
        var _getParsedAccountInfo = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee15(publicKey, commitment) {
              var args,
                unsafeRes,
                res,
                value,
                  ...
                  while (1) {
                    switch ((_context15.prev = _context15.next)) {
                      ...
                      case 7:
                        ...
                        if (res.result.value) {
                          (_res$result$value2 = res.result.value),
                            (executable = _res$result$value2.executable),
                            (owner = _res$result$value2.owner),
                            (lamports = _res$result$value2.lamports),
                            (resultData = _res$result$value2.data);
                          data = resultData;
    ...
    },
    {
      key: 'getAccountInfo',
      value: (function () {
        var _getAccountInfo = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee16(publicKey, commitment) {
              return _regeneratorRuntime__default['default'].wrap(
                function _callee16$(_context16) {
                  while (1) {
                    switch ((_context16.prev = _context16.next)) {
                      case 0:
                        _context16.next = 2;
                        return this.getAccountInfoAndContext(
                          publicKey,
                          commitment,
                        )
                          .then(function (x) {
    ...
    },
    {
      ...
      value: (function () {
        var _getStakeActivation = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee17(publicKey, commitment, epoch) {
                    ...
                    switch ((_context17.prev = _context17.next)) {
                      ...
                      case 7:
                        ...
                        (_res$result = res.result),
                          (state = _res$result.state),
                          (active = _res$result.active),
                          (inactive = _res$result.inactive);
    ...
    },
    {
      ...
      value: (function () {
        var _getProgramAccounts = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee18(programId, commitment) {
    ...
    },
    {
      ...
      value: (function () {
        var _getParsedProgramAccounts = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee19(programId, commitment) {
              var args, unsafeRes, res, result;
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      ...
      value: (function () {
        var _confirmTransaction = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee20(signature, commitment) {
              var _this = this;
                  ...
                  while (1) {
                    switch ((_context20.prev = _context20.next)) {
                      ...
                      case 4:
                        ...
                        throw new Error(
                          'signature must be base58 encoded: ' + signature,
                        );
                      ...
                      case 7:
                        ...
                        response = null;
                        confirmPromise = new Promise(function (
                          resolve,
                          reject,
                        ) {
                          try {
                            subscriptionId = _this.onSignature(
                              signature,
                        ...
                        _context20.next =
                          _context20.t1 === 'recent'
                            ? 16
                            : _context20.t1 === 'single'
                            ? 16
                            : _context20.t1 === 'singleGossip'
                            ? 16
                            : _context20.t1 === 'max'
                            ? 18
                            : _context20.t1 === 'root'
    ...
    },
    {
      key: 'getClusterNodes',
      value: (function () {
        var _getClusterNodes = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee21() {
              var unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context21.prev = _context21.next)) {
                      ...
                      case 2:
                        ...
                        throw new Error(
                          'failed to get cluster nodes: ' + res.error.message,
                        );
    ...
    },
    {
      key: 'getVoteAccounts',
      value: (function () {
        var _getVoteAccounts = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee22(commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context22.prev = _context22.next)) {
                      ...
                      case 3:
                        ...
                        throw new Error(
                          'failed to get vote accounts: ' + res.error.message,
                        );
    ...
    },
    {
      key: 'getSlot',
      value: (function () {
        var _getSlot = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee23(commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context23.prev = _context23.next)) {
                      ...
                      case 3:
                        ...
                        throw new Error(
                          'failed to get slot: ' + res.error.message,
                        );
    ...
    },
    {
      key: 'getSlotLeader',
      value: (function () {
        var _getSlotLeader = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee24(commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context24.prev = _context24.next)) {
                      ...
                      case 3:
                        ...
                        throw new Error(
                          'failed to get slot leader: ' + res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getSignatureStatus = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee25(signature, config) {
    ...
    },
    {
      ...
      value: (function () {
        var _getSignatureStatuses = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee26(signatures, config) {
    ...
    },
    {
      ...
      value: (function () {
        var _getTransactionCount = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee27(commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      key: 'getTotalSupply',
      value: (function () {
        var _getTotalSupply = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee28(commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context28.prev = _context28.next)) {
                      ...
                      case 3:
                        ...
                        throw new Error(
                          'faied to get total supply: ' + res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getInflationGovernor = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee29(commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context29.prev = _context29.next)) {
                      ...
                      case 3:
                        ...
                        throw new Error(
                          'failed to get inflation: ' + res.error.message,
                        );
                      ...
                      case 7:
                        ...
                        return _context29.abrupt(
                          'return',
                          GetInflationGovernorResult(res.result),
                        );
    ...
    },
    {
      key: 'getEpochInfo',
      value: (function () {
        var _getEpochInfo = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee30(commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context30.prev = _context30.next)) {
                      ...
                      case 3:
                        ...
                        throw new Error(
                          'failed to get epoch info: ' + res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getEpochSchedule = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee31() {
              var unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context31.prev = _context31.next)) {
                      ...
                      case 2:
                        ...
                        throw new Error(
                          'failed to get epoch schedule: ' + res.error.message,
                        );
                      ...
                      case 6:
                        ...
                        return _context31.abrupt(
                          'return',
                          GetEpochScheduleResult(res.result),
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getLeaderSchedule = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee32() {
              var unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context32.prev = _context32.next)) {
                      ...
                      case 2:
                        ...
                        throw new Error(
                          'failed to get leader schedule: ' + res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getMinimumBalanceForRentExemption = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee33(dataLength, commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context33.prev = _context33.next)) {
                      ...
                      case 3:
                        ...
                        res =
                          GetMinimumBalanceForRentExemptionRpcResult(unsafeRes);
    ...
    },
    {
      ...
      value: (function () {
        var _getRecentBlockhashAndContext = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee34(commitment) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      ...
      value: (function () {
        var _getRecentPerformanceSamples = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee35(limit) {
              var args, unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      ...
      value: (function () {
        var _getFeeCalculatorForBlockhash = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee36(blockhash, commitment) {
                  ...
                  while (1) {
                    switch ((_context36.prev = _context36.next)) {
                      ...
                      case 3:
                        ...
                        throw new Error(
                          'failed to get fee calculator: ' + res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getRecentBlockhash = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee37(commitment) {
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      key: 'getVersion',
      value: (function () {
        var _getVersion = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee38() {
              var unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context38.prev = _context38.next)) {
                      ...
                      case 2:
                        ...
                        throw new Error(
                          'failed to get version: ' + res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getConfirmedBlock = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee39(slot) {
                  ...
                  while (1) {
                    switch ((_context39.prev = _context39.next)) {
                      ...
                      case 2:
                        ...
                        throw new Error(
                          'failed to get confirmed block: ' + res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _getConfirmedTransaction = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee40(signature) {
              var unsafeRes,
                ...
                function _callee40$(_context40) {
                  while (1) {
                    switch ((_context40.prev = _context40.next)) {
                      case 0:
                        _context40.next = 2;
                        return this._rpcRequest('getConfirmedTransaction', [
                          signature,
                        ]);
    ...
    },
    {
      ...
      value: (function () {
        var _getParsedConfirmedTransaction = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee41(signature) {
              var unsafeRes,
                _GetParsedConfirmedTr,
                result,
                error,
                _result$transaction$m,
                accountKeys,
                instructions,
                recentBlockhash;
                    ...
                    switch ((_context41.prev = _context41.next)) {
                      ...
                      case 2:
                        ...
                        (_GetParsedConfirmedTr =
                          ...
                          (result = _GetParsedConfirmedTr.result),
                          (error = _GetParsedConfirmedTr.error);
                      ...
                      case 9:
                        if (result.meta.innerInstructions) {
                          result.meta.innerInstructions.forEach(function (
                            inner,
                          ) {
                            inner.instructions.forEach(function (ix) {
                              ...
                              if (ix.accounts) {
                                ix.accounts = ix.accounts.map(function (
                                  account,
                                ) {
                                  return new PublicKey(account);
                                });
                        ...
                        (_result$transaction$m = result.transaction.message),
                          (accountKeys = _result$transaction$m.accountKeys),
                          (instructions = _result$transaction$m.instructions),
                          (recentBlockhash =
                            _result$transaction$m.recentBlockhash);
                        return _context41.abrupt('return', {
                          ...
                          transaction: {
                            ...
                            message: {
                              accountKeys: accountKeys.map(function (
                                accountKey,
                              ) {
                                return {
                              ...
                              instructions: instructions.map(function (ix) {
                                ...
                                if ('accounts' in ix) {
                                  mapped.accounts = ix.accounts.map(function (
                                    key,
                                  ) {
    ...
    },
    {
      ...
      value: (function () {
        var _getConfirmedSignaturesForAddress = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee42(address, startSlot, endSlot) {
                  ...
                  while (1) {
                    switch ((_context42.prev = _context42.next)) {
                      ...
                      case 2:
                        ...
                        result =
                          GetConfirmedSignaturesForAddressRpcResult(unsafeRes);
    ...
    },
    {
      ...
      value: (function () {
        var _getConfirmedSignaturesForAddress2 = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee43(address, options) {
              var unsafeRes, result;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context43.prev = _context43.next)) {
                      ...
                      case 2:
                        ...
                        result =
                          GetConfirmedSignaturesForAddress2RpcResult(unsafeRes);
    ...
    },
    {
      ...
      value: (function () {
        var _getNonceAndContext = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee44(nonceAccount, commitment) {
    ...
    },
    {
      key: 'getNonce',
      value: (function () {
        var _getNonce = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee45(nonceAccount, commitment) {
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      key: 'requestAirdrop',
      value: (function () {
        var _requestAirdrop = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee46(to, amount) {
              var unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                function _callee46$(_context46) {
                  while (1) {
                    switch ((_context46.prev = _context46.next)) {
                      case 0:
                        _context46.next = 2;
                        return this._rpcRequest('requestAirdrop', [
                          to.toBase58(),
                          amount,
                        ]);
    ...
    },
    {
      ...
      value: (function () {
        var _recentBlockhash2 = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee47(disableCache) {
              var expired;
              return _regeneratorRuntime__default['default'].wrap(
                    ...
                    switch ((_context47.prev = _context47.next)) {
                      ...
                      case 6:
                        ...
                        return _context47.abrupt(
                          'return',
                          this._blockhashInfo.recentBlockhash,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _pollNewBlockhash2 = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee48() {
                  ...
                  while (1) {
                    switch ((_context48.prev = _context48.next)) {
                      ...
                      case 7:
                        ...
                        if (
                          !(this._blockhashInfo.recentBlockhash != blockhash)
                        ) {
                          _context48.next = 12;
                          break;
                        }
    ...
    },
    {
      ...
      value: (function () {
        var _simulateTransaction = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee49(transaction, signers) {
              var disableCache,
                signature,
                signData,
                wireTransaction,
                  ...
                  while (1) {
                    switch ((_context49.prev = _context49.next)) {
                      case 0:
                        ...
                        transaction.sign.apply(
                          transaction,
                          _toConsumableArray__default['default'](signers),
                        );
                        _context49.next = 22;
                        break;
    ...
    },
    {
      key: 'sendTransaction',
      value: (function () {
        var _sendTransaction = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee50(transaction, signers, options) {
    ...
    },
    {
      key: 'validatorExit',
      value: (function () {
        var _validatorExit = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee51() {
              var unsafeRes, res;
              return _regeneratorRuntime__default['default'].wrap(
                  ...
                  while (1) {
                    switch ((_context51.prev = _context51.next)) {
                      ...
                      case 2:
                        ...
                        throw new Error(
                          'validator exit failed: ' + res.error.message,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _sendRawTransaction = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee52(rawTransaction, options) {
                ...
                function _callee52$(_context52) {
                  while (1) {
                    switch ((_context52.prev = _context52.next)) {
                      case 0:
                        encodedTransaction =
                          toBuffer(rawTransaction).toString('base64');
                        _context52.next = 3;
                        return this.sendEncodedTransaction(
                          encodedTransaction,
                          options,
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _sendEncodedTransaction = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee53(encodedTransaction, options) {
              var config,
                args,
                skipPreflight,
                preflightCommitment,
                  ...
                  while (1) {
                    switch ((_context53.prev = _context53.next)) {
                      case 0:
                        ...
                        preflightCommitment =
                          options && options.preflightCommitment;
    ...
    },
    {
      key: '_subscribe',
      value: (function () {
        var _subscribe2 = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee54(sub, rpcMethod, rpcArgs) {
              var id;
              return _regeneratorRuntime__default['default'].wrap(
    ...
    },
    {
      key: '_unsubscribe',
      value: (function () {
        var _unsubscribe2 = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee55(sub, rpcMethod) {
                  ...
                  while (1) {
                    switch ((_context55.prev = _context55.next)) {
                      case 0:
                        ...
                        _context55.prev = 3;
                        _context55.next = 6;
                        return this._rpcWebSocket.call(rpcMethod, [
                          unsubscribeId,
                        ]);
                      ...
                      case 8:
                        ...
                        console.error(
                          ''.concat(rpcMethod, ' error:'),
                          _context55.t0.message,
                        );
    ...
    },
    {
      ...
      value: function _updateSubscriptions() {
        ...
        var accountKeys = Object.keys(this._accountChangeSubscriptions).map(
          Number,
        );
        var programKeys = Object.keys(
          this._programAccountChangeSubscriptions,
        ).map(Number);
        var slotKeys = Object.keys(this._slotSubscriptions).map(Number);
        var signatureKeys = Object.keys(this._signatureSubscriptions).map(
          Number,
        );
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
            ...
            this._subscribe(
              _sub,
              'programSubscribe',
              this._buildArgs([_sub.programId], _sub.commitment, 'base64'),
            );
          }
        } catch (err) {
          _iterator2.e(err);
        ...
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
            ...
            this._subscribe(
              _sub3,
              'signatureSubscribe',
              this._buildArgs([_sub3.signature], _sub3.commitment),
            );
          }
        } catch (err) {
          _iterator4.e(err);
    ...
    },
    {
      ...
      value: (function () {
        var _removeAccountChangeListener = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee56(id) {
              var subInfo;
              return _regeneratorRuntime__default['default'].wrap(
                function _callee56$(_context57) {
                  while (1) {
                    switch ((_context57.prev = _context57.next)) {
                      ...
                      case 8:
                        throw new Error(
                          'Unknown account change id: '.concat(id),
                        );
    ...
    },
    {
      ...
      value: function _wsOnProgramAccountNotification(notification) {
        ...
        assert__default.default(typeof res.result !== 'undefined');
        var keys = Object.keys(this._programAccountChangeSubscriptions).map(
          Number,
        );
    ...
    },
    {
      ...
      value: (function () {
        var _removeProgramAccountChangeListener = _asyncToGenerator__default[
          'default'
        ](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee57(id) {
              var subInfo;
              return _regeneratorRuntime__default['default'].wrap(
                function _callee57$(_context59) {
                  while (1) {
                    switch ((_context59.prev = _context59.next)) {
                      ...
                      case 8:
                        throw new Error(
                          'Unknown program account change id: '.concat(id),
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _removeSlotChangeListener = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee58(id) {
              var subInfo;
              return _regeneratorRuntime__default['default'].wrap(
                function _callee58$(_context60) {
                  while (1) {
    ...
    },
    {
      ...
      value: function _wsOnSignatureNotification(notification) {
        ...
        if (res.error) {
          throw new Error(
            'signature notification failed: ' + res.error.message,
          );
        }
    ...
    },
    {
      ...
      value: (function () {
        var _removeSignatureListener = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee59(id) {
              var subInfo;
              return _regeneratorRuntime__default['default'].wrap(
                function _callee59$(_context61) {
                  while (1) {
                    switch ((_context61.prev = _context61.next)) {
                      ...
                      case 8:
                        throw new Error(
                          'Unknown signature result id: '.concat(id),
                        );
    ...
    },
    {
      ...
      value: (function () {
        var _removeRootChangeListener = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee60(id) {
              var subInfo;
              return _regeneratorRuntime__default['default'].wrap(
                function _callee60$(_context62) {
                  while (1) {
...
function _sendAndConfirmTransaction() {
  _sendAndConfirmTransaction = _asyncToGenerator__default.default(
    ...
    },
    {
      ...
      value: (function () {
        var _load = _asyncToGenerator__default['default'](
          /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(
            function _callee(connection, payer, program, programId, data) {
              var balanceNeeded,
                programInfo,
                transaction,
                dataLayout,
                ...
                function _callee$(_context) {
                  while (1) {
                    switch ((_context.prev = _context.next)) {
                      ...
                      case 20:
                        dataLayout = BufferLayout.struct([
                          BufferLayout.u32('instruction'),
                      ...
                      case 41:
                        _dataLayout = BufferLayout.struct([
                          BufferLayout.u32('instruction'),
                        ]);
...
var BPF_LOADER_PROGRAM_ID = new PublicKey(
...
var STAKE_CONFIG_ID = new PublicKey(
  ...
  _createClass__default.default(Secp256k1Program, null, [
    {
      ...
      value: function createInstructionWithPublicKey(params) {
        ...
        assert__default['default'](
          ...
          'Public key must be '.concat(PUBLIC_KEY_BYTES, ' bytes'),
        );
        var ethPublicKey;
        ...
        try {
          ...
          throw new Error(
            'Error constructing ethereum public key: '.concat(error),
          );
        }
    ...
    },
    {
      ...
      value: function createInstructionWithPrivateKey(params) {
        ...
        assert__default['default'](
          ...
          'Private key must be '.concat(PRIVATE_KEY_BYTES, ' bytes'),
        );

        try {
          var publicKey = publicKeyCreate(privateKey, false);
          var messageHash = createKeccakHash__default['default']('keccak256')
...
var VOTE_PROGRAM_ID = new PublicKey(
...
function _sendAndConfirmRawTransaction() {
  _sendAndConfirmRawTransaction = _asyncToGenerator__default.default(
    /*#__PURE__*/ _regeneratorRuntime__default['default'].mark(function _callee(
      connection,
      rawTransaction,
      options,
