...
import static com.solareum.GoogleDriveApiClient.resolve;
import static com.solareum.RNCloudFsModule.TAG;

public class CopyToGDrive implements GoogleApiClient.ConnectionCallbacks {
    ...
    public CopyToGDrive(RNCloudFsModule.SourceUri sourceUri, String outputPath, @Nullable String mimeType, Promise promise, GoogleDriveApiClient googleDriveApiClient, boolean useDocumentsFolder) {
